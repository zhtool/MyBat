...
expdp system/tigersysdba tables=hscenter.REPORT_FILE_,hscenter.REPORT_CATALOG_,hscenter.report_ directory=DPPATH1 dumpfile=dp_HsCenter_REPORT.dmp logfile=dp_HsCenter_REPORT_log.log compression=NONE content=ALL reuse_dumpfiles=y  
