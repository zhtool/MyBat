...
impdp system/tigersysdba tables=hscenter.REPORT_FILE_ directory=DPPATH1 dumpfile =EXPDP_REPORT_FILE_.DMP table_exists_action=APPEND data_options=SKIP_CONSTRAINT_ERRORS parallel=2  logfile=impDP_REPORT_FILE_.log
