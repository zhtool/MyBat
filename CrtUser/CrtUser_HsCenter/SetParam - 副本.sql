...
--创建表空间 HSCENTER
create tablespace HSCENTER  logging  datafile 'D:\app\Administrator\oradata\his\HSCENTER.dbf' size 50m  autoextend on  next 50m maxsize 20480m  extent management local; 
--创建用户HSCENTER
